...
public class ImageCombinerWarpyServerOverlay extends AbstractOverlay {
	 ...
	 */
	public ImageCombinerWarpyServerOverlay(final QuPathViewer viewer, final ImageServer<BufferedImage> server) {
	 ...
	 */
	public ImageCombinerWarpyServerOverlay(final QuPathViewer viewer, final ImageServer<BufferedImage> server, final Affine affine) {
