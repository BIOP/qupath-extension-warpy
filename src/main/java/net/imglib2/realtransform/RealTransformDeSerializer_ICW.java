...
import qupath.ext.biop.warpy.BoundedRealTransform;
import qupath.ext.biop.warpy.Wrapped2DTransformAs3D;
...
public class RealTransformDeSerializer_ICW {
    ...
    public static Gson getRealTransformAdapter() {
        ...
        //RuntimeTypeAdapterFactory<RealTransform> factoryRealTransform = RuntimeTypeAdapterFactory.of(RealTransform.class);
        // TODO Fix Error
    ...
    public static RealTransform deserialize(String jsonString, Type type) {
    ...
    public static class WrappedIterativeInvertibleRealTransformAdapter implements JsonSerializer<WrappedIterativeInvertibleRealTransform>,
        ...
        @Override
        public WrappedIterativeInvertibleRealTransform<RealTransform> deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            JsonObject obj = jsonElement.getAsJsonObject();
            RealTransform rt = jsonDeserializationContext.deserialize(obj.get("wrappedTransform"), RealTransform.class);
            WrappedIterativeInvertibleRealTransform<RealTransform> ixfm = new WrappedIterativeInvertibleRealTransform<>(rt);
